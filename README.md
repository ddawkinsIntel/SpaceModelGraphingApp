...
- If you'd like to customize the colors for the processes use the SpaceModelColorMap.xlsx template located <a href="https://github.com/ddawkinsIntel/SpaceModelGraphingApp/blob/master/SpaceModelColorMap.xlsx"> download here</a> and save it in the same location as the .exe file
